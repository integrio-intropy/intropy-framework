...
/// <summary>
/// An abstract base for checking idempotency.
/// </summary>
...
public abstract class IdempotencyCheckStep<T, TCtx> : TechnicalStep<T, T, TCtx>
{
    /// <inheritdoc />
    public override string StepName => "IdempotencyCheck";
}